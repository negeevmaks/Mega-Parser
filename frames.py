...
options = {
    "AUTO.RIA": ['options.AUTO.RIA.1', 'options.AUTO.RIA.2', 'options.AUTO.RIA.3', 
                'options.AUTO.RIA.4', 'options.AUTO.RIA.5', 'options.AUTO.RIA.6', 
                'options.AUTO.RIA.7', 'options.AUTO.RIA.8', 'options.AUTO.RIA.9'], 
...
class PriceChooseFrame(ctk.CTkFrame):
    def __init__(self, master):
        ...
        self.price_main_title =  ctk.CTkLabel(self, text="Ціна", 
                                            fg_color=("#C0C0C0","gray30"), 
                                            corner_radius=6)
